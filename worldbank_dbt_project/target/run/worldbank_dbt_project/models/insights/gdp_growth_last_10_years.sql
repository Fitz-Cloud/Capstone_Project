...
create or replace transient table WORLD_BANK_PROJECT.MART_insights.gdp_growth_last_10_years
    

    
    as (with gdp_growth as (
  select
    country_key,
...
from growth_calc g
join WORLD_BANK_PROJECT.MART_mart.dim_country c on g.country_key = c.country_key
